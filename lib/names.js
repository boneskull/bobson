...
import {lineObservable} from './util';
import * as mutations from './mutations';
import * as random from './random';
import _ from 'lodash/fp';
import {isPronounceable} from './filters';
import d from 'debug';
import surnameStats from '../data/surnames.json';
import firstnameStats from '../data/firstnames.json';

const stats = {
  surname: surnameStats,
  firstname: firstnameStats
};
